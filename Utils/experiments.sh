#!/bin/sh
mkdir ../outputs/Fepsintosoftmax_stateUncertainty0and0bigfish/
mkdir ../outputs/Fepsintosoftmax_stateUncertainty0and0bigfish/Markdown
mkdir ../outputs/Fepsintosoftmax_stateUncertainty0and0bigfish/Agents
mkdir ../outputs/Fepsintosoftmax_stateUncertainty0and0bigfish/Collectors
bsub -o "../outputs/Fepsintosoftmax_stateUncertainty0and0bigfish/Markdown/Fepsintosoftmax_stateUncertainty0and0bigfish_0.md" -J "Fepsintosoftmax_stateUncertainty0and0bigfish_0" -P "Fepsintosoftmax_stateUncertainty0and0bigfish-0 -environment bigfish -uncertainty 1 -state_difference 1 -uncertainty_weight 0 -state_difference_weight 0 -exploration epsintosoftmax" < submit.sh
