#!/bin/sh
mkdir ../outputs/Final_stateUncertainty0and0bigfish/
mkdir ../outputs/Final_stateUncertainty0and0bigfish/Markdown
mkdir ../outputs/Final_stateUncertainty0and0bigfish/Agents
mkdir ../outputs/Final_stateUncertainty0and0bigfish/Collectors
bsub -o "../outputs/Final_stateUncertainty0and0bigfish/Markdown/Final_stateUncertainty0and0bigfish_0.md" -J "Final_stateUncertainty0and0bigfish_0" -P "Final_stateUncertainty0and0bigfish-0 -environment bigfish -uncertainty 1 -state_difference 1 -uncertainty_weight 0 -state_difference_weight 0" < submit.sh
