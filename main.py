...
if isServer:
    ...
    agent = Agent(memory=40000, discount=0.995, uncertainty=True, update_every=100, double=True, state_difference=True, uncertainty_weight=0, state_difference_weight=10)
