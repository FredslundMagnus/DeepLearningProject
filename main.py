...
if isServer:
    ...
    agent = Agent(memory=40000, discount=0.99, uncertainty=1, state_difference=1, uncertainty_weight=0.25, state_difference_weight=0.25, exploration='epsintosoftmax')
